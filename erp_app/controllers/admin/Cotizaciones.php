...
class Cotizaciones extends ADMIN_Controller {
    ...
    public function index() {
        ...
        $this->js    = [
            'items'     => base_url('admin/cotizaciones/get_datatable'),
            'columns'   => $columns,
        ];
        ...
        $this->fdata = [
            'js'            => $js,
            'link_active' => ['liOrdenTrabajo', 'lkCotizaciones'],
        ];

        $this->data = [
            'url_agregar'   => base_url('admin/cotizaciones/mostrar_form'),
            'header'        => 'Cotizaciones',
        ];

        $this->load->view('admin/common/header_view', $this->hdata);
        $this->load->view('admin/cotizaciones/index_view', $this->data);
