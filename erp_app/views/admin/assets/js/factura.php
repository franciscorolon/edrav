...
<script type="text/javascript">
    ...
    $(document).on('click', '.xml-upload', function(e){
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function (o) {
                if (o.result == 1) {
                    ...
                    var icon  = (icono == 'icon-pdf') ? 'pdf_active.png' : 'xml_active.png';
                    if(icono == 'icon-pdf'){
	                    $('#pdf_file').val(o.file);
                    }else{
	                    $('#xml_file').val(o.file);
                    ...
                    image.fadeOut('fast', function () {
                        image.attr('src', '<?=base_url('assets/img/icons/')?>' + icon);
                        image.fadeIn('slow');
                    });
...
<script type="text/javascript">
    ...
    function redirect_facturas(){
        window.location.replace("<?=base_url('admin/facturas')?>");
    }
