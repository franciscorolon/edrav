...
<script type="text/javascript">
  ...
  '</button>';
       ...
       var demo = $('[data-fancybox="gallery"]').fancybox({
        ...
        $(document).on('click','#listado', function(e){
            e.preventDefault();
            $('#seleccionar').css('display', 'none');
            $('#guardar-listado').css('display', 'block');
            $('.listado-item').removeClass('col-2').addClass('col-12');
            $('.listado-item .image').removeClass('col-12').addClass('col-3');
            $('.listado-item .nombre').css('display', 'block');
        });

        $(document).on('click','#cuadricula', function(e){
            e.preventDefault();
            $('#seleccionar').css('display', 'block');
            $('#guardar-listado').css('display', 'none');
            $('.listado-item').removeClass('col-12').addClass('col-2');
            $('.listado-item .image').removeClass('col-3').addClass('col-12');
            $('.listado-item .nombre').css('display', 'none');
        });
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        if($('.dropzone.expediente').length > 0){
            drop = new Dropzone(".dropzone.expediente", {
                init: function() {
                    this.on("success", function(file, response) {
                        $('.dropzone.expediente .dz-preview.dz-file-preview').remove();
                ...
                parallelChunkUploads: true,
                url: $(".dropzone.expediente").data('url'),
                dictDefaultMessage: 'Soltar archivos para subir',
                dictFallbackMessage: 'Su navegador no admite la carga de archivos arrastrados.',
            });
        }
