        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="number" class="form-control text-right" id="no_recibo" aria-required="true" value="<?=isset($detalle)?$detalle['cantidad']:''?>">
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group row">
                    <label class="col-sm-6 col-form-label">Pieza</label>
                    <div class="col-sm-6">
