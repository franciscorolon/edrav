...
<form role="form" method="post" action="<?=$URL_FORM?>" class="ajaxPostFormModal" data-function-success="mostrar_recibo">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control plaintext text-right red" id="no_orden" readonly="" aria-required="true" value="<?=$orden['no_placas']?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control plaintext red" id="auto" readonly="" aria-required="true" value="<?=strtoupper($orden['marca'].' '.$orden['tipo'].' '.$orden['color'].' modelo:'.$orden['modelo'])?>">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input name="recibimos_de" class="form-control" value="<?=$cliente['nombre'].' '.$cliente['paterno'].' '.$cliente['materno']?>"/>
                </div>
            </div>
        </div>
        <div class="row">
