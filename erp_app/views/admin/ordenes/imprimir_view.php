<div class="invoice padding-50 sm-padding-10">
    <div>
        <div class="pull-left">
            <img width="235" height="47" alt="" class="invoice-logo" data-src-retina="<?=base_url('assets/img/edrav/logo_dashboard.png')?>" data-src="<?=base_url('assets/img/edrav/logo_dashboard.png')?>" src="<?=base_url('assets/img/edrav/logo_dashboard.png')?>">
        ...
        <div class="pull-right sm-m-t-20">
            <h2 class="font-montserrat all-caps hint-text">ORDEN</h2>
        </div>
